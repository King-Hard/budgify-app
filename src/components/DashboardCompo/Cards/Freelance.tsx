...
export default function FreelanceCard({description, amount, date, category, createdAt}) {
  return (
    <div className="flex items-center p-4 gap-2 rounded-lg mt-3 bg-gray-50">
      <div>
        <Laptop className="h-10 w-10 p-2.5 border border-green-300 rounded-md flex items-center text-green-500 bg-green-50"/>
      </div>

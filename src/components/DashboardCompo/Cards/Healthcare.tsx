...
export default function HealthCareCard({description, amount, date, category, createdAt}) {
  return (
    <div className="flex items-center p-4 gap-2 rounded-lg mt-3 bg-gray-50">
      <div>
        <Cross className="h-10 w-10 p-2.5 border border-red-300 rounded-md flex items-center text-red-500 bg-red-50"/>
      </div>

...
import QuickStats from "@/components/AdminCompo/QuickStats";
...
export default function Navigations({ isCollapsed, totalIncome, totalExpense }: SidebarProps) {
  ...
  return (
    <div className="border-r border-gray-200 flex flex-col w-[256px] h-full">
      ...
      <div className="p-5 pt-3">
        ...
        >
          <Link href="/budgify/bill" className="flex items-center gap-3 p-3">
        ...
        >
          <Link href="/budgify/goal" className="flex items-center gap-3 p-3">
            <Target className="w-4 h-4" />
            Goal Tracker
          </Link>
        </div>
        <QuickStats totalIncome={totalIncome} totalExpense={totalExpense} />
      </div>
    </div>
  );
};
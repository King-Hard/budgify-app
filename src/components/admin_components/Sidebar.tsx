    ...
    <div className="flex flex-col border-r border-gray-200 w-[61px] h-screen">
      ...
      <div className="flex flex-col items-center py-5 space-y-2">
        <Link
          ...
          className={`p-3 rounded-md cursor-pointer ${pathName === "/admin/dashboard" ? "bg-blue-50 text-blue-600 border border-blue-500" : "text-black border border-gray-200 hover:text-blue-600 hover:bg-blue-50 hover:border-blue-500"}`}
          title="Dashboard"
        >
        ...
        <Link
          ...
          className={`p-3 rounded-md cursor-pointer ${pathName === "/admin/bill_reminder" ? "bg-violet-50 text-violet-600 border border-violet-500" : "text-black border border-gray-200 hover:text-violet-600 hover:bg-violet-50 hover:border-violet-500"}`}
          title="Bill Reminder"
        >
        ...
        <Link
          ...
          className={`p-3 rounded-md cursor-pointer ${pathName === "/admin/goal_tracker" ? "bg-orange-50 text-orange-600 border border-orange-500" : "text-black border border-gray-200 hover:text-orange-600 hover:bg-orange-50 hover:border-orange-500"}`}
          title="Goal Tracker"
        >
  ...
  return (
    <div className="border-r border-gray-200 flex flex-col w-[256px] h-screen">
      ...
      <div className="p-5 pt-3">
        ...
        <div className={`${pathName === "/admin/add_budget" ? "text-yellow-600 bg-yellow-50 border border-yellow-500 font-medium mt-1 rounded-md" : "font-medium mt-1 rounded-md border border-gray-200 hover:text-yellow-600 hover:bg-yellow-50 hover:border-yellow-500"}`}>
          <Link
            href="/admin/add_budget"
            className="flex items-center gap-3 p-3"
          >
        ...
        <div className={`${pathName === "/admin/goal_tracker" ? "text-orange-600 bg-orange-50 border border-orange-500 font-medium mt-1 rounded-md" : "font-medium mt-1 rounded-md border border-gray-200 hover:text-orange-600 hover:bg-orange-50 hover:border-orange-500"}`}>
          <Link
            href="/admin/goal_tracker"
            className="flex items-center gap-3 p-3"
          >

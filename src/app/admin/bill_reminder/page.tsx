            ...
            <div className="w-full">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center justify-center border border-yellow-200 bg-yellow-50 text-yellow-500 px-2 rounded-full gap-1">
                    <Clock className="h-4 w-4 sm:w-3 sm:h-3"/>
          ...
          <div className="flex items-center gap-2 p-4 rounded-lg mt-3 bg-slate-50">
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center justify-center border border-red-200 bg-red-50 text-red-500 px-2 rounded-full gap-1">
                    <TriangleAlert className="h-4 w-4 sm:w-3 sm:h-3"/>
          ...
          <div className="flex items-center gap-2 p-4 rounded-lg mt-3 bg-slate-50">
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center justify-center border border-green-200 bg-green-50 text-green-500 px-2 rounded-full gap-1">
                    <CheckCircle className="h-4 w-4 sm:w-3 sm:h-3"/>

...
export default function AddBudget() {
  ...
  return (
    <div className="p-5 border-l border-gray-200">
      <div className="mb-6">
        <h1 className="text-[#3786F2] text-3xl font-bold">Add Transaction</h1>
      ...
      <div className="max-w-[550px] bg-white p-4 rounded-lg shadow-md">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            <CircleDollarSign className="text-[#3786F2] w-7 h-7"/>
        ...
        <div className="border w-full flex justify-around p-1.5 font-medium rounded-md mb-4">
          <button
            className={
              transaction
                ? `flex items-center justify-center gap-2 p-1 border border-red-300 rounded-md w-auto md:w-60 bg-red-50 px-3 cursor-pointer`
                : "flex items-center justify-center gap-2 p-1 border border-white rounded-md w-auto md:w-60 px-3 cursor-pointer"
            }
          ...
          <button
            className={
              !transaction
                ? `flex items-center justify-center gap-2 p-1 border border-green-300 rounded-md w-auto md:w-60 bg-green-50 px-3 cursor-pointer`
                : "flex items-center justify-center gap-2 p-1 border border-white rounded-md w-auto md:w-60 px-3 cursor-pointer"
            }
